        ...
        <Modal.Dialog className="how-it-works">
          ...
          <Modal.Body>
            <ol>
              ...
              <li><strong>Run when you’re ready.</strong><p>Add your TypeSafe API key in Settings, then choose Run now to process new mail, the last 30 days, or your entire inbox. Or turn on automatic cleanup in Settings for new mail.</p></li>
            </ol>
            <p className="muted">Actions apply directly in Gmail. AI can make mistakes, so start with a label or star and check the results before using archive. Mable does not store email content; it sends the content needed for evaluation to TypeSafe using your key.</p>
          </Modal.Body>
        </Modal.Dialog>
      </Modal.Container>
    </Modal.Backdrop>
